              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                      ...
                      <li class="active"><a href="admins_offline.php"><i class="fa fa-file-text-o"></i> Offline</a></li>
              ...
              <div class="box box-primary">
                ...
                <div class="box-body no-padding">
                 <div class="mailbox-controls">
                    <!-- Check all button -->                    
                    <div class="btn-group">
                        <a class="btn btn-default btn-sm" href="admins_online.php" title="see all admin"><i class="fa fa-reply"></i></a>
                        <a class="btn btn-default btn-sm" href="admins_deleted.php" title="See admin online"><i class="fa fa-share"></i></a>
                    </div><!-- /.btn-group -->
                  ...
                  <div class="table-responsive mailbox-messages">
                    <table class="table table-hover table-striped">
                      ...
                      <tbody>
                          <?php 
                          $n=1;
                          foreach($user->advance_search_admin_offline() as $single_admin){
                              echo "<tr><td>$n</td>";
