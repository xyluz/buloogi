                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php
                          $n=1;
                         foreach($data->getData($_SESSION[admin_id],$_GET[id]) as $single_data){
                             echo " <tr><td>$n</td>
                          <td>$single_data[Ticker]</td>
                          <td>$single_data[P_Close]</td>
                          <td>$single_data[Open]</td>
                          <td>$single_data[High]</td>
                          <td>$single_data[Low] </td>
                          <td>$single_data[Percent_Spread] </td>  
                          <td>$single_data[Close]  </td> 
                          <td>$single_data[Change_a]  </td> 
                          <td>$single_data[Percent_Change]  </td> 
                          <td>$single_data[Trades]  </td> 
                          <td>$single_data[Volume]  </td> 
