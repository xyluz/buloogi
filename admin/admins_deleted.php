              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                      ...
                      <li class="active"><a href="admins_deleted.php"><i class="fa fa-trash-o"></i> Deleted</a></li>
                  </ul>
                </div><!-- /.box-body -->
              </div><!-- /. box -->
                ...
                <div class="box-body no-padding">
                  <div class="box-footer no-padding">
                   <div class="mailbox-controls">
                    <!-- Check all button -->                    
                    <div class="btn-group">
                        <a class="btn btn-default btn-sm" href="admins_offline.php" title="see admin offline"><i class="fa fa-reply"></i></a>
                        <a class="btn btn-default btn-sm" href="#"><i class="fa fa-share"></i></a>
                    </div><!-- /.btn-group -->
                    <button class="btn btn-default btn-sm" onclick="window.location.reload(); alert('refresh done')" title="refresh"><i class="fa fa-refresh"></i></button>
                  ...
                  <div class="table-responsive mailbox-messages">
                    <table class="table table-hover table-striped">
                      ...
                      <tbody>
                          <?php 
                          $n=1;
                          foreach($user->advance_search_admin_deleted() as $single_admin){
                              echo "<tr><td>$n</td>";
