...
?>
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                      <li class="active"><a href="admins.php"><i class="fa fa-inbox"></i> All <span class="label label-primary pull-right"><?php foreach($user->count_admin() as $admins){ echo $admins['count(*)'];} ?></span></a></li>
                      <li><a href="admins_online.php"><i class="fa fa-envelope-o"></i> Online</a></li>
              ...
              <div class="box box-primary">
                ...
                <div class="box-body no-padding">
                  <div class="mailbox-controls">
                    <!-- Check all button -->                    
                    <div class="btn-group">
                      <a class="btn btn-default btn-sm" href="#"><i class="fa fa-reply"></i></a>
                      <a class="btn btn-default btn-sm" href="admins_online.php" title="See admin online"><i class="fa fa-share"></i></a>
                    </div><!-- /.btn-group -->
                    <button class="btn btn-default btn-sm" onclick="window.location.reload(); alert('refresh done')"><i class="fa fa-refresh"></i></button>
                  ...
                  <div class="table-responsive mailbox-messages">
                    <table class="table table-hover table-striped">
                      ...
                      <tbody>
                          <?php 
                          $n=1;
                          foreach($user->advance_search_admin() as $single_admin){
                              echo "<tr><td>$n</td>";
                              
                              echo "<td class='mailbox-name'><a href='single_admin.php?id=$single_admin[admin_id]'>$single_admin[fullName]</a></td>";
                ...
                <div class="box-footer no-padding">
                  <div class="mailbox-controls">
                    ...
                    <div class="btn-group">
                      ...
                      <button class="btn btn-default btn-sm" href="admins_online.php" title="See admin online"><i class="fa fa-share"></i></button>
                    </div><!-- /.btn-group -->
                    <button class="btn btn-default btn-sm" onclick="window.location.reload(); alert('refresh done')"><i class="fa fa-refresh"></i></button>
    ...
    <!--<script src="admin_code.js" type="text/javascript"></script>-->
  </body>
</html>